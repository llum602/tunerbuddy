...
import pitchE from './pitchLowE.wav';
import pitchG from './pitchG.wav';
import pitchB from './pitchB.wav';
...
class Guitar extends React.Component {
    ...
    playB = () => {
      ...
      render() {
        ...
        return (
            <div>
                <div className="instruTitles"><h2><b>Guitar</b></h2></div>
                <div id="toggleBox">
                    <ButtonToolbar>
                        <ToggleButtonGroup type="checkbox" name="options" justified>
                            <ToggleButton value={1} onChange={this.playE}>E</ToggleButton>
                            <ToggleButton value={2} onChange={this.playA}>A</ToggleButton>
                            <ToggleButton value={3} onChange={this.playD}>D</ToggleButton>
                            <ToggleButton value={4} onChange={this.playG}>G</ToggleButton>
                            <ToggleButton value={5} onChange={this.playB}>B</ToggleButton>
                            <ToggleButton value={6} onChange={this.playE}>E</ToggleButton>
                        </ToggleButtonGroup>
                    </ButtonToolbar>
                </div>
            </div>
